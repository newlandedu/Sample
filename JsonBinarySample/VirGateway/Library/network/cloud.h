...
#define NEWLAND_CLOUD_DBG(fmt, args...)	printf("NEWLAND CLOUD DBG[%s][%d]: "fmt, __FILE__, __LINE__, ##args)
#else
#define NEWLAND_CLOUD_DBG(fmt, args...)
#endif

//#define NEWLAND_CLOUD_DEERR
#ifdef NEWLAND_CLOUD_DEERR
#define NEWLAND_CLOUD_ERR(fmt, args...)	printf("NEWLAND CLOUD ERR[%s][%d]: "fmt, __FILE__, __LINE__, ##args)
#else
#define NEWLAND_CLOUD_ERR(fmt, args...)
#endif
